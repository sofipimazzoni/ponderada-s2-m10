...
class CacheManager {
  constructor(store, connectionString, useRedisSets, logger, errorHandler, defaultTtl) {
     ...
     */
    __publicField$l(this, "storeFactories", {
     ...
     */
    __publicField$l(this, "memoryStore", /* @__PURE__ */ new Map());
    __publicField$l(this, "logger");
    __publicField$l(this, "store");
    __publicField$l(this, "connection");
    __publicField$l(this, "useRedisSets");
    __publicField$l(this, "errorHandler");
    __publicField$l(this, "defaultTtl");
...
__publicField$k(_AzureUrlReader, "factory", ({ config, treeResponseFactory }) => {
...
__publicField$j(_BitbucketCloudUrlReader, "factory", ({ config, treeResponseFactory }) => {
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
__publicField$i(_BitbucketUrlReader, "factory", ({ config, logger, treeResponseFactory }) => {
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
__publicField$h(_BitbucketServerUrlReader, "factory", ({ config, treeResponseFactory }) => {
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
const _Git = class _Git {
  constructor(config) {
    this.config = config;
    __publicField$g(this, "headers");
    __publicField$g(this, "onAuth");
    __publicField$g(this, "onProgressHandler", () => {
      let currentPhase = "";
      return (event) => {
        var _a, _b;
...
__publicField$g(_Git, "fromAuth", (options) => {
...
__publicField$f(_GerritUrlReader, "factory", ({ config, treeResponseFactory }) => {
  var _a;
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
const _GithubUrlReader = class _GithubUrlReader {
  constructor(integration, deps) {
    this.integration = integration;
    this.deps = deps;
    __publicField$e(this, "getCredentials", async (url, options) => {
...
__publicField$e(_GithubUrlReader, "factory", ({ config, treeResponseFactory }) => {
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
__publicField$d(_GitlabUrlReader, "factory", ({ config, treeResponseFactory }) => {
  const integrations = integration.ScmIntegrations.fromConfig(config);
...
__publicField$c(_GiteaUrlReader, "factory", ({ config, treeResponseFactory }) => {

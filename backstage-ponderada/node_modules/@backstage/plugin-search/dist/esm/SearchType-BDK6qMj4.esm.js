...
const SearchPage$1 = searchPlugin.provide(
  createRoutableExtension({
    name: "SearchPage",
    component: () => import('./index-LeUeJAxm.esm.js').then((m) => m.SearchPage),
...
const SidebarSearchModal = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-4C-7QFYg.esm.js').then(
...
const HomePageSearchBar = searchPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./index-By276Am7.esm.js').then((m) => m.HomePageSearchBar)
    }
  })
);
...
//# sourceMappingURL=SearchType-BDK6qMj4.esm.js.map
